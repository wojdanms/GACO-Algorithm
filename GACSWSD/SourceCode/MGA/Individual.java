...
Individual() throws JWNLException, CloneNotSupportedException
{
    ...
    Create_Individual_Randomly_ACS();
    Calc_fitness();
}
//*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^
 // Constructor
...
//*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^*^
// Create_Individual_Randomly_ACS Function: creat randomly individual
void Create_Individual_Randomly_ACS()
{
    Random randomGenerator = new Random();
    //m
    Individual[0]=1+(randomGenerator.nextInt((2*Numnode)));
    //q0
    Individual[1]=(float) (((float)randomGenerator.nextInt(101))/100.0);
    //alpha
    Individual[2]=randomGenerator.nextInt(6);
    //beta
    Individual[3]=randomGenerator.nextInt(11);
    //evap
    Individual[4]=(float) (((float)randomGenerator.nextInt(101))/100.0);
    //localevap
    Individual[5]=(float) (((float)randomGenerator.nextInt(101))/100.0);
    //Q
    Individual[6]=randomGenerator.nextInt(101);
    //T0
    Individual[7]=(float) (((float)randomGenerator.nextInt(51))/100.0);
    //lambda
    Individual[8]=randomGenerator.nextInt(11);
